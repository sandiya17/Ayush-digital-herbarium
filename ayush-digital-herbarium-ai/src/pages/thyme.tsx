...
const ThymePage: React.FC<PlantDetailsProps> = () => {
  ...
  const plantData = {
    ...
    description: "Thyme is a fragrant perennial herb with small, aromatic leaves and delicate purple, pink, or white flowers. It forms low-growing bushes with woody stems and is highly valued for both culinary and medicinal purposes. The plant has a warm, pungent aroma with earthy, minty, and slightly lemony notes, making it a versatile herb in various cuisines and traditional remedies.",
    medicinalUses: [
      "Powerful antiseptic and antimicrobial properties",
      "Relieves respiratory conditions like bronchitis and coughs",
      "Supports immune system function",
      "Aids digestion and reduces stomach cramps",
    ...
    plantingTips: [
      "Climate: Prefers warm, sunny locations (USDA zones 5-9)",
      "Soil: Well-draining, sandy or rocky soil with pH 6.0-8.0",
      "Sunlight: Full sun (6+ hours daily)",
      "Planting: Start from cuttings, divisions, or seeds",
      "Spacing: 12-18 inches between plants",
      "Watering: Drought-tolerant; water only when soil is dry",
      "Pruning: Harvest regularly to prevent woody growth",
      "Harvest: Snip stems as needed; best flavor before flowering"
    ],
    growingSeason: "Spring to Fall",
    maturityTime: "90-180 days from seed",
    hardinessZones: "5-9"
  };
                ...
                {show3DModel && (
                  <div className="mt-4 bg-gray-900 rounded-xl p-4 aspect-video flex items-center justify-center">
                    ...
                    <div className="text-white text-center">
                      ...
                      <p className="text-sm opacity-75">3D Model of Thyme Plant</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <audio ref={audioRef} src="/audio/thyme-description.mp4" />
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="mt-4 p-4 bg-amber-50 rounded-lg border-l-4 border-amber-400">
                <p className="text-amber-800 text-sm">
                  <strong>Historical Note:</strong> Thyme has been used for thousands of years for both culinary and medicinal purposes. The ancient Egyptians used thyme in embalming practices, while the ancient Greeks used it in their baths and burnt it as incense in temples, believing it was a source of courage. The Romans spread thyme throughout Europe, using it to purify rooms and flavor cheese and alcoholic beverages. During the Middle Ages, thyme was placed under pillows to ward off nightmares and was given to knights before battle as a symbol of courage. The name "thyme" derives from the Greek word "thumos," meaning courage or spirit.
                </p>
              </div>
            </div>
